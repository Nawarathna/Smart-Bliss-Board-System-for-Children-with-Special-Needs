...
namespace sampleframe.cs
{
    public partial class tutorScreen : Form
    {
        ...
        public tutorScreen()
        {
            ...
            panel1.BackColor = Color.FromArgb(125, Color.Navy);
            lblStudent.Text = "";
        }
        ...
        {
            textBox1.Text = textBox1.Text + " " + "Hello";
            SoundPlayer splayer = new SoundPlayer(@"H:\level 3\1 nd semester\uni 3rd year\1st semester\project\Project Version\2020-05-09\wave\Hello.wav");
            splayer.Play();
        }
